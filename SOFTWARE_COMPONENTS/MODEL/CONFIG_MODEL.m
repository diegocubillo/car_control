...
MODEL.PARAM.MOTOR_BEMF_CONSTANT = 0.539111; % 19: 0.546182;
% Torque constant (N.m/A)
MODEL.PARAM.MOTOR_TORQUE_CONSTANT = 0.539111; % 19: 0.546182;
% Motor inertia (kg.m^2)
MODEL.PARAM.MOTOR_INERTIA = 0.000319592; % 19: 0.00147497;
% Viscous friction constant (N.m.s/rad)
MODEL.PARAM.MOTOR_VISCOUS_FRICTION_COEFF = 0.000931;
% Static friction torque (N.m)
MODEL.PARAM.MOTOR_STATIC_TORQUE = 0.0732413; % 19: 0.0737492;
% Motor converter voltage drop (V)
MODEL.PARAM.MOTOR_VOLT_DROP_COM = 0;
MODEL.PARAM.MOTOR_VOLT_DROP_DIF = -0.0104855; % 19: -0.00720927;
...
%--------------------------------------------------------------
% Wheel mass (kg)
MODEL.PARAM.WHEEL_MASS = 0.121; % 19: 0.147;
% Wheel radius (m)
MODEL.PARAM.WHEEL_RADIUS = 0.05;
% Wheel distance (m)
MODEL.PARAM.WHEEL_DISTANCE = 0.2037;
% Body mass (kg)
MODEL.PARAM.BODY_MASS = 1.646-2*MODEL.PARAM.WHEEL_MASS'; % 19: 1.5-2*MODEL.PARAM.WHEEL_MASS';
...
MODEL.PARAM.BODY_INERTIA_Z = 0.0487598; % 19: 0.0212602;
...
MODEL.PARAM.BODY_VISCOUS_FRICTION_COEFF_Z = 0.0193121; % 19: 0.117047;
